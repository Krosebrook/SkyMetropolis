        ...
        <div className="flex gap-1 md:gap-2 bg-gray-900/80 p-1 md:p-2 rounded-2xl border border-gray-600/50 backdrop-blur-xl shadow-2xl w-full md:w-auto overflow-x-auto no-scrollbar justify-start md:justify-start">
          ...
          {installPrompt && (
            <button
              ...
              className="flex flex-col items-center justify-center rounded-lg border-2 border-yellow-500/50 bg-yellow-900/40 hover:bg-yellow-800/60 transition-all w-14 h-14 md:w-16 md:h-16 flex-shrink-0 animate-pulse"
              title="Install App"
            >
