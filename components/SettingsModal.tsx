...
export const SettingsModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const handleReset = () => {
    if (window.confirm("Are you sure? This will delete your city.")) {
      resetGame();
      window.location.reload(); // Hard reload to clear scene state properly
    }
  };
        ...
        <div className="mb-6">
          ...
          <input 
            ...
            onChange={(e) => {
               ...
               setVolume(v);
               // AudioService doesn't have a live volume setter exposed in the interface for brevity, 
               // but in a real app we'd bind it. For now, it updates the store.
            }}
