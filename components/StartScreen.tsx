...
const StartScreen: React.FC<StartScreenProps> = ({ onStart }) => {
  ...
  const handleStart = () => {
    // Explicitly play a sound here if needed, but App.tsx handles initialization via onStart callback.
    // However, playing a sound immediately here ensures the context wakes up.
