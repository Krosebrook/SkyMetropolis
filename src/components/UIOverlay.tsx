...
import { StatsPanel } from '../features/ui/components/StatsPanel';
import { GoalCard } from '../features/ui/components/GoalCard';
import { NewsTicker } from '../features/ui/components/NewsTicker';
import { GameToolbar } from '../features/ui/components/GameToolbar';
import { SettingsDialog } from '../features/ui/components/SettingsDialog';
  ...
  return (
    <>
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2 w-full max-w-full">
            <StatsPanel stats={stats} onSettings={() => setShowSettings(true)} />
            <GoalCard 
                goal={currentGoal} 
                aiEnabled={aiEnabled} 
        ...
        <div className="flex flex-col-reverse md:flex-row md:justify-between md:items-end mt-auto gap-2 w-full max-w-full">
            <GameToolbar 
                ...
                onInstall={onInstall} 
            />
            <NewsTicker feed={newsFeed} aiEnabled={aiEnabled} />
        </div>
